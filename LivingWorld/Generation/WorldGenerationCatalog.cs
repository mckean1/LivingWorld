...
internal static class WorldGenerationCatalog
{
    ...
    public static List<PrimitiveLineageTemplate> CreatePrimitiveLineageTemplates()
        => new()
        {
            new(
                "mat_reeds",
                ...
                0.46,
                0.00,
                [RegionBiome.RiverValley, RegionBiome.Wetlands, RegionBiome.Coast],
                []),
            new(
                "stone_lichen",
                "Stone Lichen",
                ...
                0.34,
                0.00,
                [RegionBiome.Highlands, RegionBiome.Mountains, RegionBiome.Drylands, RegionBiome.Forest],
                []),
            new(
                "softshell_grazers",
                "Softshell Grazers",
                ...
                0.34,
                0.02,
                [RegionBiome.Plains, RegionBiome.RiverValley, RegionBiome.Forest, RegionBiome.Wetlands],
                ["mat_reeds", "stone_lichen"],
                4,
                0.08,
                0.04),
            new(
                ...
                0.36,
                0.03,
                [RegionBiome.Wetlands, RegionBiome.RiverValley, RegionBiome.Coast],
                ["mat_reeds"],
                5,
                0.10,
                0.06),
            new(
                ...
                0.44,
                0.05,
                [RegionBiome.Coast, RegionBiome.Forest, RegionBiome.Plains, RegionBiome.Wetlands, RegionBiome.Highlands],
                ["mat_reeds", "softshell_grazers", "mud_foragers"],
                6,
                0.14,
                0.08),
            new(
                ...
                0.56,
                0.10,
                [RegionBiome.Forest, RegionBiome.Plains, RegionBiome.Highlands, RegionBiome.RiverValley],
                ["softshell_grazers", "mud_foragers", "drift_scavengers"],
                8,
                0.22,
                0.18),
            new(
                ...
                0.58,
                0.12,
                [RegionBiome.Wetlands, RegionBiome.RiverValley, RegionBiome.Forest, RegionBiome.Coast],
                ["mud_foragers", "drift_scavengers", "softshell_grazers"],
                9,
                0.26,
                0.16)
        };
